    ...
    private var offers: [Offer] {
        [
            Offer(
                ...
                dueToday: Pricing.ace1DueToday,
                dueTodayCaption: "Nothing due today — \(Pricing.ace1TrialDays)-day free trial",
                monthlyCaption: "\(Pricing.format(Pricing.certificateFee)) certificate, then \(Pricing.format(Pricing.monthlySubscription))/mo after your trial",
                perks: [
                    "Free for \(Pricing.ace1TrialDays) days, no charge today",
