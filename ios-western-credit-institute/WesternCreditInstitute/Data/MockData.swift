...
nonisolated enum MockData {
    ...
    static let courses: [Course] = [
        ...
        Course(
            ...
            duration: "6 weeks",
            lessons: 41,
            price: Pricing.certificateFee,
            certificationFee: Pricing.certificateFee,
            freeTrialDays: Pricing.ace1FreeDays,
            monthlyFee: Pricing.monthlySubscription,
        ...
        Course(
            ...
            fullDescription: "This Advanced Credit Education course is designed to teach insider secrets and advanced techniques to successfully build business credit. Learn how to establish corporate credit, secure business funding, and leverage credit for business expansion. Enrollment is a $99.99 certificate fee plus a $100 enrollment fee, then $49.99 per month to keep your subscription. There is no free trial for this course. This course is 3 of 4 in the Advanced Credit Education program.",
            duration: "Self-paced",
            lessons: 28,
            price: Pricing.enrollmentFee,
            certificationFee: Pricing.certificateFee,
        ...
        Course(
            ...
            shortDescription: "One payment, lifetime access. Includes ACE-1, ACE-2 and ACE-3, all AI tools, all three certificates, the affiliate network and every future update - with no monthly subscription ever.",
            fullDescription: "The Complete ACE Bundle is a one-time payment of $1,299.00 for LIFETIME access to all three Advanced Credit Education courses (ACE-1: Advanced Credit Repair, ACE-2: Advanced Credit Building, and ACE-3: Advanced Business Credit). Your one payment includes every AI tool, certificates for all three courses, access to the affiliate network, and all future updates at no extra cost. There is no monthly subscription and no enrollment fee - you never pay again. Upon completion you will be eligible for CSO Certification.",
            ...
            features: [
                "Lifetime Access to All 3 Courses",
                "No Monthly Subscription - One Payment",
            ...
            learningObjectives: [
                "Lifetime Access - No Monthly Subscription Ever",
    ...
    static let earnings: [EarningRecord] = [
        EarningRecord(id: "1", type: .referral, amount: Pricing.referralAce1Enrolled, date: date("2024-12-28"), detail: "ACE-1 referral - Sarah Johnson", status: .completed),
        EarningRecord(id: "2", type: .commission, amount: Pricing.bundlePayoutCSO, date: date("2024-12-25"), detail: "Complete ACE Bundle sale (50% CSO commission)", status: .completed),
        EarningRecord(id: "3", type: .commission, amount: Pricing.referralAce23Bounty, date: date("2024-12-20"), detail: "ACE-2 registration - Sarah Johnson", status: .completed),
    ...
    static let walletTransactions: [WalletTransaction] = [
        WalletTransaction(id: "1", type: .referralBonus, amount: Pricing.referralAce1Enrolled, status: .completed, detail: "ACE-1 Referral - Sarah Johnson", createdAt: date("2025-01-08T10:30:00Z")),
        WalletTransaction(id: "2", type: .commission, amount: Pricing.referralAce23Bounty, status: .pending, detail: "ACE-2 Registration Bonus - Sarah Johnson", createdAt: date("2025-01-07T00:00:00Z")),
        WalletTransaction(id: "3", type: .commission, amount: Pricing.bundlePayoutCSO, status: .completed, detail: "50% Commission - Complete ACE Bundle Sale", createdAt: date("2025-01-05T14:22:00Z")),
        ...
        WalletTransaction(id: "6", type: .referralBonus, amount: Pricing.referralAce1Enrolled, status: .completed, detail: "ACE-1 Referral - James Wilson", createdAt: date("2024-12-25T11:00:00Z")),
    ]
